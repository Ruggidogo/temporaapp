        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary mb-6">
              ...
              <span className="text-sm font-medium">{t("cookies.title")}</span>
            </div>
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none">
              <div className="p-8 rounded-3xl border border-border/50 bg-card/50 backdrop-blur-sm space-y-8">
                ...
                <p className="text-sm text-muted-foreground">
                  {t("cookies.lastUpdate")} 19 Gennaio 2026
                </p>
                ...
                <section>
                  <h2 className="text-2xl font-bold mb-4">{t("cookies.section8.title")}</h2>
                  <p className="text-muted-foreground leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold mb-4">{t("cookies.section9.title")}</h2>
                  <p className="text-muted-foreground leading-relaxed">
                    {t("cookies.section9.content")}
                  </p>
                </section>
